...
- **WHEN** a consumer directly depends on NES SDE or HLRC without the starter
- **THEN** validation either proves the producer POM supplies the replacement or reports the missing transitive replacement as an open adoption gate
