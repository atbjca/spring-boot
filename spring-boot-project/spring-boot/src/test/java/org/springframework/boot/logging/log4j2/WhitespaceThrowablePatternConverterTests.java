...
class WhitespaceThrowablePatternConverterTests {
	...
	@ParameterizedTest
	@ValueSource(strings = { "wEx", "wThrowable", "wException" })
	...
	@Test
	void shortOptionFormatsFirstStackTraceElementWithoutCause() {
		String output = format(
				WhitespaceThrowablePatternConverter.newInstance(this.configuration, new String[] { "short" }),
				eventWithCause());
	...
	@Test
	void fullOptionFormatsCause() {
		String output = format(
				WhitespaceThrowablePatternConverter.newInstance(this.configuration, new String[] { "full" }),
				eventWithCause());
		assertThat(output).startsWith("\njava.lang.IllegalStateException: failure")
	...
	@Test
	void separatorOptionIsPropagatedToThrowableConverter() {
		String output = format(WhitespaceThrowablePatternConverter.newInstance(this.configuration,
